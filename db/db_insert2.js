function registerRestaurant(restLogin, restPW, restName, restLong, restLat, restPhone, callback) {
...
function registerDriver(driverLogin, driverPW, driverName, driverLong, driverLat, drivePhone, driverPay, callback) {
  var mysql = require('mysql');
  var con = mysql.createConnection({
    host: "db",
    user: "root",
...
function createOrder(orderVal, restID, driverID, callback) {
  var mysql = require('mysql');
  var con = mysql.createConnection({
    host: "db",
    user: "root",
